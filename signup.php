...
if(isset($_POST['signup'])){
    ...
    if($res = mysqli_query($conn,"SELECT * FROM user WHERE userid = '$uid'")){
        ...
        else if(mysqli_query($conn,"INSERT INTO user(userid,password,username,address,city,phone,email) VALUES('$uid','$password','$uname','$uadd','$ucity','$uphone','$uemail')") ){
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="oq-signup text-center">
                            ...
                            <form class="form" action="" method="post" name="create">
                                ...
                                <input type="text" class="form-control" placeholder="Enter your name" name="username" ><br>
                                <span id="adderror" class="oq-error"></span>
                                <input type="text" class="form-control" placeholder="Enter your Address" name="useraddress" ><br>
                                <span id="cityerror" class="oq-error"></span>
                                <input type="text" class="form-control" placeholder="Enter your City" name="usercity" ><br>
                                <span id="phoneerror" class="oq-error"></span>
                                <input type="text" class="form-control" placeholder="Enter your Phone" name="userphone" ><br>
                                <span id="mailerror" class="oq-error"></span>
                                <input type="text" class="form-control" placeholder="Enter your Email" name="useremail" ><br><br>
