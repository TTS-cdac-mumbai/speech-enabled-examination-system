                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        <div class="oq-viewTests" id="test">
                                            <div class="oq-instruct">
                                                ...
                                                <p id="instructions">Instructions are <br>1. The questions will be spoken out, you need to select the correct option by saying its option number. <br> example if the correct answer is option 2 then you need to say option 2 then that perticular option will be selected. <br>2. To repeate a question you need to say the word repeat question.<br>3. You can even navigate between questions by saying the question numbers example, question 2 then question 2 will be spoken.<br>4. You can submit any time while taking the quiz to submit you need to say submit, your test will be submitted and resutls are shown.<br><br>Say start to start your exam with timer<br></p><br>
                                                <p id="spresult1" class="spresult1"></p>
                                                <?php
                                                    if($res = mysqli_query($conn,"SELECT * FROM `$lang` where tests = '$test' ")){
                                                        $data = mysqli_fetch_assoc($res);
                                                        echo "<h4 id='speakTimer'>Time remaining : <span id='timer'>" . $data['testtime'] . " Minutes </span></h4>";
                                                        echo "<h4 id='totalMarks'>Total Marks : <span id='total_marks'>" . $data['total_marks'] . "</span></h4>";
                                                    }
                                                ?>
                                                <!-- <h4 id="speakTimer">Time remaining : <span id="timer">40 Minutes 0 seconds</span></h4>
                                                <h4 id="TotalMarks">Total Marks : <span id="total_marks"> -->
                                                </span></h4>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-8">
                                                            ...
                                                            if(mysqli_num_rows($res)>0){
                                                                ...
                                                                while($row = mysqli_fetch_assoc($res)){
                                                                    ...
                                                                    echo "
                                                                        ...
                                                                        echo "<button class='oq-aLeft oq-questions oq-form-control' disabled> Question ".nl2br($row['q_no']). ". " .nl2br($row['questions'])."</button>";
                                                                        // echo "<span> Type : " . $row['q_type']. "</span><br>";
                                                                        echo "<span> Marks : " . $row['marks']. "</span><br>";
                                                                    ...
                                                                    }else if($row['q_type'] == "none"){
                                                                    }else{
                                                                        echo "<textarea rows='4' cols='70' id='qus".$i."' name='qus".$i."' placeholder='your answer here'></textarea>";
